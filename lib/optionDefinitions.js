...
// combined with AND operator when there are multiple values
{
  name: 'excludeSites',
  type: String
}, // modifies the search query by adding "gl" parameter to the query string
// to restrict the search to a specific country
{
  name: 'gl',
  type: String
}, // modifies the search query by adding "lr" parameter to the query string
// to restrict the search to a specific language
{
  name: 'lr',
  type: String
}
